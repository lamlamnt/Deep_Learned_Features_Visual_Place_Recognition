...
int main() {
    ...
    //This searches for .trt file with specific name in the directory
    string trtpath = "/home/lamlam/data/cpp_data/multiseason_layer16.trt";
    bool succ = engine.build(trtpath);
    if (!succ) {
    ...
    const std::string inputImage = "/Volumes/oridatastore09/ThirdPartyData/utias/multiseason/run_000001/images/left/000057.png";
    ...
    //for(int i = 0; i < 1; i++){
        ...
        for (size_t j = 0; j < batchSize; ++j) {
            ...
            //cv::cuda::resize(img, resized, cv::Size(inputDims[0].d[2], inputDims[0].d[1]));
